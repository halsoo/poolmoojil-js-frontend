...
import { getOrderHistoryByOrderNum, changeOrderStatus } from '../../util/api';
import { timeStampToDate, priceStr, priceStrToInt } from '../../util/localeStrings';

export default class AdminStoreOrderItem extends Component {
    constructor(props) {
        super(props);
        this.state = {
            order: undefined,
    ...
    editStatus = async (event) => {
        ...
        const res = await changeOrderStatus(this.state.order.id, value);
...
function OrderStatus(props) {
    ...
    return (
        <div className="w-50% h-full mb-6 flex flex-col text-green-500">
            ...
            <StatusSelector value={order.transactionStatus} onChange={props.onChange} />
        </div>
    );
}
    ...
    return (
        <div className="mb-4 grid grid-cols-12">
            ...
            <select className="col-start-4 col-end-7" value={props.value} onChange={props.onChange}>
                ...
                <option value="반품 교환 신청">반품 교환 신청</option>
