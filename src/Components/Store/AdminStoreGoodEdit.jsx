...
import { uploadImage, getGoodByID, editGood } from '../../util/api';
import { priceStr, priceStrToInt } from '../../util/localeStrings';

export default class AdminStoreGoodEdit extends Component {
    constructor(props) {
        super(props);
        this.state = {
            good: undefined,
    ...
    edit = async () => {
        ...
        const res = await editGood(infos);
        if (res.status === 200) {
            window.location.href = '/store/good';
        }
    };
