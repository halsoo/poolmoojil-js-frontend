...
function ButtonGroup(props) {
    return (
        <div className="mt-2 flex flex-row justify-between ">
            <button className="w-49% lg:h-18 sm:h-32 text-2xl text-green-500 border border-green-500">
                <Link to={'/gathering/onetime/' + props.id}>1회 참가 신청</Link>
            </button>

            <button className="w-49% lg:h-18 sm:h-32 text-2xl text-white bg-green-500">
...
function ButtonOne(props) {
    return (
        <div className="mt-2 flex flex-row justify-between ">
            <button className="w-full lg:h-18 sm:h-32 text-2xl text-white bg-green-500">
...
function ButtonLogin(props) {
    return (
        <div className="mt-2 flex flex-row justify-between ">
            <button
                className="w-full lg:h-18 sm:h-32 text-white text-2xl bg-green-500"
                name="needLogin"
            >
